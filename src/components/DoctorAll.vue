...
<script type="text/ecmascript-6">
  ...
  import {GETALLDOCTOR} from '../store/type'
  ...
  export default {
    ...
    methods   : {
      ...
      isShowDoct(id){
        var hideDoc = [2369, 2400, 2430, 2401, 2427, 2563, 2679, 2509, 2722]
        return hideDoc.indexOf(id) == -1
      }
    },
    created () {
      this.$store.dispatch(GETALLDOCTOR, this.param)
    },
    watch     : {
      getAllDoctor (newValue, oldVaue) {
